...
if response.status_code == 200:
    ...
    for div in presentation_divs:
        ...
        property_details_div = residential_content.find('div', {'class': 'Inline__InlineContainer-sc-lf7x8d-0 iuOPWU'})
...
# Find the div containing bedroom, bathroom, and parking information
property_details_div = residential_content.find('div', {'class': 'Inline__InlineContainer-sc-lf7x8d-0 iuOPWU'})
